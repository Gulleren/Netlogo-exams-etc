...
to-report my-nr-bias1's-standard-bias1
...
to-report my-nr-bias1's-standard-bias2
...
to-report my-nr-bias2's-standard-bias1
...
to-report my-nr-bias2's-standard-bias2
...
;to-report my-nr-bias1's-echo1-bias1
...
;; @@@@ VI GØR DET OMVENDT :D:D:D:D Vi kalder en specific to-report i set-my-stations. ask ppls --> if bias = 1 --> set my-stations1 n-of my-nr-bias1's-echo1-bias1
...
to set-my-stations
  ...
  ask ppls [
    ...
    if bias = 1 [
    set my-stations1 n-of my-nr-bias1's-standard-bias1 bias1's
    set my-stations2 n-of my-nr-bias2's-standard-bias1 bias2's

    ]

    if bias = 2 [
    set my-stations1 n-of my-nr-bias1's-standard-bias2 bias1's
    set my-stations2 n-of my-nr-bias2's-standard-bias2 bias2's
    ]
  ]
  ]
